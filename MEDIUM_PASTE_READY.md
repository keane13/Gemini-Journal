...
▓▓▓▓▓▓▓▓▓▓ UPLOAD IMAGE 01 HERE ▓▓▓▓▓▓▓▓▓▓
File     : screenshots/01-*.png
Shows    : A quiet writing surface for honest introspection — the Nightstand landing page
Caption  : Nightstand. The promise on the landing page is the one the rest of this article has to earn.
▓▓▓▓▓▓▓▓▓▓ (delete these 5 lines after uploading) ▓▓▓▓▓▓▓▓▓▓
...
▓▓▓▓▓▓▓▓▓▓ UPLOAD IMAGE 02 HERE ▓▓▓▓▓▓▓▓▓▓
File     : screenshots/02-*.png
Shows    : The Egress Ledger showing masked entity counts and the exact payload sent upstream
Caption  : The Egress Ledger. Not a summary of what was sent — the actual bytes.
▓▓▓▓▓▓▓▓▓▓ (delete these 5 lines after uploading) ▓▓▓▓▓▓▓▓▓▓
...
▓▓▓▓▓▓▓▓▓▓ UPLOAD IMAGE 03 HERE ▓▓▓▓▓▓▓▓▓▓
File     : screenshots/03-*.png
Shows    : The self-test page with nine checks passing, each showing elapsed time and directive
Caption  : Nine adversarial checks against the running app. Failures render exactly as prominently as passes.
▓▓▓▓▓▓▓▓▓▓ (delete these 5 lines after uploading) ▓▓▓▓▓▓▓▓▓▓
...
▓▓▓▓▓▓▓▓▓▓ UPLOAD IMAGE 04 HERE ▓▓▓▓▓▓▓▓▓▓
File     : screenshots/04-*.png
Shows    : The expanded raw response for the prompt injection check, showing Gemini's actual reply
Caption  : The injection check shows Gemini's actual reply, so you judge containment yourself rather than trusting a green tick.
▓▓▓▓▓▓▓▓▓▓ (delete these 5 lines after uploading) ▓▓▓▓▓▓▓▓▓▓
...
▓▓▓▓▓▓▓▓▓▓ UPLOAD IMAGE 05 HERE ▓▓▓▓▓▓▓▓▓▓
File     : screenshots/05-*.png
Shows    : The admin console header stating it cannot read user entries, with suppressed metrics
Caption  : Cells backed by fewer than five users read "withheld". That is the feature working, not a bug.
▓▓▓▓▓▓▓▓▓▓ (delete these 5 lines after uploading) ▓▓▓▓▓▓▓▓▓▓
...
▓▓▓▓▓▓▓▓▓▓ UPLOAD IMAGE 06 HERE ▓▓▓▓▓▓▓▓▓▓
File     : screenshots/06-*.png
Shows    : The Prove it panel showing a 403 PERMISSION_DENIED next to a successful 200 control probe
Caption  : Target probe denied. Control probe succeeds. The token works — the refusal is authorization.
▓▓▓▓▓▓▓▓▓▓ (delete these 5 lines after uploading) ▓▓▓▓▓▓▓▓▓▓
...
▓▓▓▓▓▓▓▓▓▓ UPLOAD IMAGE 07 HERE ▓▓▓▓▓▓▓▓▓▓
File     : screenshots/07-*.png
Shows    : The retention settings panel showing 30/90/365/never options and the irreversibility warning
Caption  : Every other AI product races to remember more about you. This one deliberately forgets.
▓▓▓▓▓▓▓▓▓▓ (delete these 5 lines after uploading) ▓▓▓▓▓▓▓▓▓▓
...
▓▓▓▓▓▓▓▓▓▓ UPLOAD IMAGE 08 HERE ▓▓▓▓▓▓▓▓▓▓
File     : screenshots/08-*.png
Shows    : The journal entry view with the marginalia gutter, text column and context rail
Caption  : Marks in the gutter are an index of the text, never decoration. Nothing appears there that is not derived from the content beside it.
▓▓▓▓▓▓▓▓▓▓ (delete these 5 lines after uploading) ▓▓▓▓▓▓▓▓▓▓
